...
//        }])->sum('value');
    ...
    {
        $data = ContractPayment::whereIn('contract_id', $this->userable->contracts->pluck('id'))->where('paid', 0)->whereNull('submit_date')->whereNotNull('date')->orderBy('date', 'asc')->limit(1)->first();

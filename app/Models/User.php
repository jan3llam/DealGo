...
//        }])->sum('value');
    ...
    {
        $data = ContractPayment::whereIn('contract_id', $this->userable->contracts->pluck('id'))->whereNull('paid')->whereNotNull('date')->whereNull('submit_date')->orderBy('date', 'desc')->get();
        dd($data);

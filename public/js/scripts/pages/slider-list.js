$(function () {
    ...
    var dtTable = $('.sliders-list-table'),
        newSidebar = $('.new-slider-modal'),
        viewSidebar = $('.view-slider-modal'),
    ...
    if (dtTable.length) {
        var link = assetPath + 'api/admin/slider/list';
        dtTable.dataTable({
            ajax: function (data, callback, settings) {
                // make a regular ajax request using data.start and data.length
                $.ajax({
                    url: assetPath + 'api/admin/slider/list',
                    data: {
                        length: data.length,
                        lang: $('html').attr('lang'),
                        start: data.start,
        ...
        if (ids.length) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: 'DELETE',
                        url: assetPath + 'api/admin/slider/bulk',
                        data: {ids: ids},
                        dataType: 'json',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),

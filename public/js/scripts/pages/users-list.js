...
$(function () {
    ...
    if (dtTable.length) {
        dtTable.DataTable({
            ajax: assetPath + 'api/admin/users/list',
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            '<a href="/admin/user/' + full['id'] + '" class="dropdown-item" data-id="' + full['id'] + '">' +
    ...
    $(document).on('click', '.item-delete', function () {
        ...
        $.ajax({
            type: 'DELETE',
            url: assetPath + 'api/admin/users/' + element.data('id'),
            dataType: 'json',
    ...
    $(document).on('click', '.status-switcher', function () {
        ...
        $.ajax({
            type: 'PUT',
            url: assetPath + 'api/admin/users/status/' + element.data('id'),
            dataType: 'json',
            success: function (response) {
                if (parseInt(response.code) === 1) {
                    dtTable.DataTable().ajax.reload();

    ...
    <section class="advantages-list">
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive pt-0">
                <table class="advantages-list-table table">
            ...
            <div class="modal modal-slide-in new-advantage-modal fade" data-bs-keyboard="false"
                 data-bs-backdrop="static"
                 id="modals-slide-in">
                <div class="modal-dialog">
                    <form class="add-new-advantage modal-content pt-0">
                        ...
                        <div class="modal-header mb-1">
                            ...
                            <input type="hidden" id="edit___label" value="{{__('locale.Edit')}} {{__('locale.Advantage')}}">
                        </div>
            ...
            <div class="modal modal-slide-in view-advantage-modal fade">
                <div class="modal-dialog">
...
@section('page-script')
    {{-- Page js files --}}
    <script src="{{ asset(mix('js/scripts/pages/advantages-list.js')) }}"></script>
@endsection

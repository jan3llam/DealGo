...
@section('content')
    ...
    <section class="offices-list">
        ...
        <div class="card">
            ...
            <div class="modal modal-slide-in new-office-modal fade" id="modals-slide-in" data-backdrop="static"
                 data-keyboard="false">
            ...
            <div class="modal modal-slide-in view-office-modal fade">
                <div class="modal-dialog">
                    <div class="modal-content pt-0">
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
                        <div class="modal-header mb-1">
                            <h5 class="modal-title" id="modal-label">View shipping agent</h5>
                        </div>
                        <div class="modal-body flex-grow-1">

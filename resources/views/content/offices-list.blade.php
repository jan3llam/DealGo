...
@section('title', __('locale.Offices'))
...
@section('content')
    ...
    <section class="offices-list">
        ...
        <div class="card">
            ...
            <div class="modal modal-slide-in new-office-modal fade" data-bs-keyboard="false" data-bs-backdrop="static"
                 id="modals-slide-in">
                <div class="modal-dialog">
                    <form class="add-new-office modal-content pt-0">
                        ...
                        <div class="modal-header mb-1">
                            <h5 class="modal-title" id="modal-label">{{__('locale.Add')}} {{__('locale.Office')}}</h5>
                            <input type="hidden" id="edit___label" value="{{__('locale.Edit')}} {{__('locale.Office')}}">
                        </div>
            ...
            <div class="modal modal-slide-in view-office-modal fade">
                <div class="modal-dialog">
                    <div class="modal-content pt-0">
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
                        <div class="modal-header mb-1">
                            <h5 class="modal-title" id="modal-label">{{__('locale.View')}} {{__('locale.Office')}}</h5>
                        </div>
                        <div class="modal-body flex-grow-1">

...
@section('content')
    ...
    <section class="tenants-list">
        ...
        <div class="card">
            ...
            <div class="modal modal-slide-in new-tenant-modal fade" data-bs-keyboard="false" data-bs-backdrop="static"
                 id="modals-slide-in">
                <div class="modal-dialog">
                    <form class="add-new-tenant modal-content pt-0">
                        ...
                        <div class="modal-header mb-1">
                            ...
                            <input type="hidden" id="edit___label" value="{{__('locale.Edit')}} {{__('locale.Tenant')}}">
                        ...
                        <div class="modal-body flex-grow-1">
                            ...
                            <div class="info-container">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25">{{__('locale.GoodsTypes')}}:</span>
                                        <span id="view-goods"></span>
                                    </li>
                                    <li class="mb-75">

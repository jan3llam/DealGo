...
@section('content')
    ...
    <section class="vessels-list">
        ...
        <div class="card">
            ...
            <div class="modal modal-slide-in new-vessel-modal fade" data-bs-keyboard="false" data-bs-backdrop="static"
                 id="modals-slide-in">
                <div class="modal-dialog">
                    <form class="add-new-vessel modal-content pt-0">
                        ...
                        <div class="modal-header mb-1">
                            ...
                            <input type="hidden" id="edit___label" value="{{__('locale.Edit')}} {{__('locale.Vessel')}}">
